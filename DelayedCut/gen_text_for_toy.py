...
def main():
    ...
    ap.add_argument("--prompt_min", type=float, default=0.7)
    ap.add_argument("--prompt_max", type=float, default=12)
    ap.add_argument("--delayed_min", type=float, default=6)
    ap.add_argument("--delayed_max", type=float, default=12)
    args = ap.parse_args()
